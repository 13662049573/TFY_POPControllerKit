...
@interface TFY_PopDragView : UIView
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(TFY_PopDragView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(TFY_PopDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(TFY_PopDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(TFY_PopDragView *dragView);
