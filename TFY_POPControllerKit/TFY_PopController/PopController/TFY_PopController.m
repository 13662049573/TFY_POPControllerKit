...
static NSMutableSet * _Nonnull _retainedPopControllers;

@interface UIViewController (Internal)

@property (nonatomic, weak) TFY_PopController * _Nullable popController;
...
@property (nonatomic, copy) NSDictionary * _Nullable keyboardInfo;

@property (nonatomic, strong) TFY_PopTransitioningDelegate * _Nullable transitioningDelegate;
...
- (void)setupObserverForViewController:(UIViewController *_Nonnull)viewController {
...
- (void)destroyObserverOfViewController:(UIViewController *_Nonnull)viewController {
...
- (UIView <UIKeyInput> *_Nonnull)getCurrentTextInputInView:(UIView *_Nonnull)view {
...
- (void)setup {
    ...
    self.popType = PopTypeGrowIn;
    self.dismissType = DismissTypeFadeOut;
...
- (PopContainerViewController *)containerViewController {
    if (!_containerViewController) {
        _containerViewController = [PopContainerViewController new];
        _containerViewController.modalPresentationStyle = UIModalPresentationCustom;
        self.transitioningDelegate = [[TFY_PopTransitioningDelegate alloc] initWithPopController:self];
